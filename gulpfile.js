...
import { optimizeRaster, optimizeVector, sprite } from './gulp/img.js';
...
export function startServer() {
  ...
  watch(`${PATH_TO_SOURCE}img/sprite/**/*.svg`, series(sprite, refresh));
  watch(`${PATH_TO_SOURCE}img/svg/**/*.svg`, series(optimizeVector, refresh));
